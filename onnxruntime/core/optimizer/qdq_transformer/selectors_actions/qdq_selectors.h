...
class NodeGroupSelector {
 ...
 protected:
  ...
  bool CheckQDQNodes(const GraphViewer& graph_viewer, const Node& node, const Node* p_activation_node,
 ...
 private:
  ...
  bool virtual Check(const GraphViewer& graph_viewer, const Node& node, const Node* p_activation_node,
                     const std::vector<const Node*>& dq_nodes,
...
class DropQDQNodeGroupSelector : public NodeGroupSelector {
 ...
 private:
  bool Check(const GraphViewer& graph_viewer, const Node& node, const Node* p_activation_node,
             const std::vector<const Node*>& dq_nodes,
